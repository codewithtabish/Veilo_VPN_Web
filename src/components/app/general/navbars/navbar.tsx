...
const CONTACT_EMAIL = "support@YOUR-DOMAIN.com";

export default function AboutPage() {
  return (
    <main className="bg-background text-foreground">
      {/* 1. Hero */}
      <header className="border-b border-border py-16 sm:py-20 lg:py-28">
      ...
      <div className="space-y-20 py-16 sm:space-y-24 sm:py-20 lg:space-y-28 lg:py-24">
        ...
        <section aria-labelledby="what-is-veilo">
          ...
          <div className="mt-6 max-w-3xl space-y-5 text-muted-foreground leading-relaxed">
            <p>
        ...
        {/* 6. How Veilo Works at a High Level */}
